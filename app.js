const TRIP_CONFIG = {
  ...
  mapSpots: [
    { name: '新青森駅', icon: '🚄', type: 'planned', x: 46, y: 43, note: 'ビューンで到着＆帰りもここから。', link: 'https://www.jreast.co.jp/estation/station/info.aspx?StationCd=1586' },
    { name: '青森魚菜センター', icon: '🐟', type: 'planned', x: 52, y: 39, note: 'のっけ丼で旅の最初から優勝。', link: 'https://nokkedon.jp/' },
    { name: '三内丸山遺跡', icon: '🪵', type: 'planned', x: 43, y: 46, note: '世界遺産の縄文ロマン。', link: 'https://sannaimaruyama.pref.aomori.jp/' },
    { name: '青森県立美術館', icon: '🐶', type: 'planned', x: 39, y: 51, note: 'あおもり犬に会いに行く。', link: 'https://www.aomori-museum.jp/' },
    { name: '奥入瀬渓流', icon: '💧', type: 'planned', x: 67, y: 68, note: '銚子大滝と水音の散歩道。', link: 'https://oirase-fm.com/' },
    { name: '十和田湖', icon: '🏮', type: 'planned', x: 63, y: 82, note: '湖水まつりで夜までロマンチック。', link: 'https://kosuimaturi.com/' },
    { name: '弘前城', icon: '🌸', type: 'famous', x: 24, y: 66, note: '桜で有名。次回の春旅候補。', link: 'https://www.hirosakipark.jp/' },
    { name: '八甲田ロープウェー', icon: '🚡', type: 'famous', x: 53, y: 58, note: '山の絶景。晴れた日に狙いたい。', link: 'https://www.hakkoda-ropeway.jp/' },
    { name: '酸ヶ湯温泉', icon: '♨️', type: 'famous', x: 49, y: 62, note: '青森の名湯。温泉好きなら候補。', link: 'https://sukayu.jp/' },
    { name: '浅虫温泉', icon: '🌊', type: 'famous', x: 67, y: 38, note: '海沿い温泉。ゆるい寄り道候補。', link: 'https://www.asamushi.com/' },
    { name: '白神山地', icon: '🌳', type: 'famous', x: 11, y: 72, note: '世界自然遺産。いつか深呼吸旅。', link: 'https://www.shirakami-visitor.jp/' }
  ],
  days: [
    {
      id: 'day1',
...
function renderAomoriMap() {
  ...
  map.innerHTML = `
    <div class="map-shape" aria-hidden="true">
      <span class="map-sea sea-left">🌊</span>
      <span class="map-sea sea-right">🌊</span>
      <span class="map-apple">🍎</span>
      <span class="map-label">AOMORI</span>
    </div>
    ${TRIP_CONFIG.mapSpots.map((spot, index) => `
      <a class="map-spot ${spot.type} reveal" href="${spot.link}" target="_blank" rel="noopener noreferrer" style="--x:${spot.x}%; --y:${spot.y}%; --delay:${index * 45}ms">
